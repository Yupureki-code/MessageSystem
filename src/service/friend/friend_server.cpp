...
DEFINE_string(access_host, "127.0.0.1:8006", "当前实例的外部访问地址");

DEFINE_int32(listen_port, 8006, "Rpc服务器监听端口");
...
int main()
{
    messageSystem::initLogger("friend_logger", FLAGS_log_file, spdlog::level::debug);
    FriendServerWrapper server(REGISTRY_HOST,FLAGS_access_host);
