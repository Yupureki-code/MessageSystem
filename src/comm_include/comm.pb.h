...
class MessageInfo final :
 ...
 public:
  ...
  // .messageSystem.UserInfo sender = 4;
  bool has_sender() const;
  private:
  bool _internal_has_sender() const;
  public:
  void clear_sender();
  const ::messageSystem::UserInfo& sender() const;
  PROTOBUF_NODISCARD ::messageSystem::UserInfo* release_sender();
  ::messageSystem::UserInfo* mutable_sender();
  void set_allocated_sender(::messageSystem::UserInfo* sender);
  private:
  const ::messageSystem::UserInfo& _internal_sender() const;
  ::messageSystem::UserInfo* _internal_mutable_sender();
  public:
  void unsafe_arena_set_allocated_sender(
      ::messageSystem::UserInfo* sender);
  ::messageSystem::UserInfo* unsafe_arena_release_sender();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr conversation_id_;
    ::messageSystem::UserInfo* sender_;
...
inline const ::messageSystem::UserInfo& MessageInfo::_internal_sender() const {
  const ::messageSystem::UserInfo* p = _impl_.sender_;
  return p != nullptr ? *p : reinterpret_cast<const ::messageSystem::UserInfo&>(
      ::messageSystem::_UserInfo_default_instance_);
}
inline const ::messageSystem::UserInfo& MessageInfo::sender() const {
  // @@protoc_insertion_point(field_get:messageSystem.MessageInfo.sender)
...
inline void MessageInfo::unsafe_arena_set_allocated_sender(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:messageSystem.MessageInfo.sender)
}
inline ::messageSystem::UserInfo* MessageInfo::release_sender() {
  
  ::messageSystem::UserInfo* temp = _impl_.sender_;
  _impl_.sender_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::messageSystem::UserInfo* MessageInfo::unsafe_arena_release_sender() {
  // @@protoc_insertion_point(field_release:messageSystem.MessageInfo.sender)
  
  ::messageSystem::UserInfo* temp = _impl_.sender_;
  _impl_.sender_ = nullptr;
  return temp;
}
inline ::messageSystem::UserInfo* MessageInfo::_internal_mutable_sender() {
...
inline ::messageSystem::UserInfo* MessageInfo::mutable_sender() {
  ::messageSystem::UserInfo* _msg = _internal_mutable_sender();
  // @@protoc_insertion_point(field_mutable:messageSystem.MessageInfo.sender)
  return _msg;
}
inline void MessageInfo::set_allocated_sender(::messageSystem::UserInfo* sender) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.sender_;
  }
  ...
  _impl_.sender_ = sender;
  // @@protoc_insertion_point(field_set_allocated:messageSystem.MessageInfo.sender)
}
